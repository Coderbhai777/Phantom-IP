...
*   **USIO SQL Exploit Engine**: Custom high-speed injection discovery and credential exfiltration (Username/Password) tool.
*   **IP Geolocation Tracking**: Powered by the **IPGeoLocation** project by **@maldevel**. 
*   **Protocol Bridge (IPv6 -> IPv4)**: Force IPv4 stack resolution for targets.

## ⚖️ Credits & Attribution
Phantom-IP integrates several powerful open-source utilities. Full credit is given to the original author:
*   **IPGeoLocation**: Originally created by [maldevel](https://github.com/maldevel/IPGeoLocation).
*   **SQL-Injection-Payloads-List**: Payloads sourced and curated for the USIO engine.
*   **Recon Tools**: Standard industry tools like `nmap` and `sqlmap`.
...
## 🌟 Support
If you find this USIO toolkit valuable, please give us a star on GitHub!
